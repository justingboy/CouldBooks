...
public class StyleActivity extends Activity {
	...
	private SwitchButton sbDefault, sbChangeFaceControl, sbIOS, sbInCode,
			sbEnable, sbMd;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Configuration conf = Configuration
				.getDefault(getResources()
						.getDisplayMetrics().density);
		conf.setOnColor(Color.parseColor("#ff0000"));
		sbDefault.setConfiguration(conf);
		...
		container.addView(sbInCode, ViewGroup.LayoutParams.WRAP_CONTENT,
		...
		sbDefault.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView,
				...
				Toast.makeText(
						StyleActivity.this,
						"Default style button, new state: "
								+ (isChecked ? "on" : "off"),
