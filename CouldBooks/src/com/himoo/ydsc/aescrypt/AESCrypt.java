...
public final class AESCrypt {
	 ...
	 *            used to generated key
	 * @param message
	 *            the thing you want to encrypt assumed String UTF-8
	 * @return Base64 encoded CipherText
	 * @throws GeneralSecurityException
	 *             if problems occur during encryption
	 */
	 ...
	 *            Initiation Vector
	 * @param message
	 *            in bytes (assumed it's already been decoded)
	 ...
	 *            the encrpyted message encoded with base64
	 * @return message in Plain text (String UTF-8)
	 * @throws GeneralSecurityException
	 *             if there's an issue decrypting
	 */
