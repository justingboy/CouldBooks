...
public abstract class BaseActivity extends FragmentActivity implements OnClickListener,
		OnItemClickListener, OnItemLongClickListener, OnPageChangeListener,
		OnLongClickListener, OnItemSelectedListener,CompoundButton.OnCheckedChangeListener,ServiceListener {
...
//		ViewUtils.inject(this);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK && event.getAction() == KeyEvent.ACTION_DOWN) {
			if((System.currentTimeMillis() - exitTime) > 2000 && (activitys.indexOfValue(getActivityName()) != -1)){
				Toast.showShort(this, "再按一次退出程序");
				exitTime = System.currentTimeMillis();
			} else if ((activitys.indexOfValue(getActivityName()) != -1)) {
				BaseApplication.getInstance().exit();
			}
		}
		if (keyCode == KeyEvent.KEYCODE_BACK && (activitys.indexOfValue(getActivityName()) != -1)) {
			return true;
...
//	}
	...
	/**
	 * 无需强转的findViewById()方法
	 * @param id
	 * @return
	 */
	public View findViewToId(int id) {
