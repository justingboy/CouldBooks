...
public class TabPageIndicator extends HorizontalScrollView implements
	...
	/** The drawable of text direction on Left */
	private static int DRAWABLE_DIRECTION = 1;

	/** The drawable of text direction on Left */
	public static final int DRAWABLE_LEFT = 1;

	/** The drawable of text direction on right */
	public static final int DRAWABLE_RIGHT = 2;

	/** The drawable of text direction on top */
	...
	private void addTab(int index, CharSequence text, int iconResId) {
		...
		if (iconResId != 0) {
			...
			case DRAWABLE_BOTTOM:
				tabView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0,
						iconResId);
	...
	/**
	 * set drawable of text direction
	 * 
	 * @param direction
	 */
	public void setResDirection(int direction) {
